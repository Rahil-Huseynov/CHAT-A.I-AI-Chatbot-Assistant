          ...
          <div className="flex items-start gap-2 max-w-[85%] w-full">
            <div className="flex-1 flex flex-col items-end">
              <textarea
                ...
                className="w-full p-2 text-xs bg-muted rounded-lg border border-primary/30 outline-none focus:ring-2 focus:ring-primary/20 resize-none"
                rows={3}
                autoFocus
              />
        ...
        <div className="flex items-center justify-between pt-3 mt-2">
          ...
          {isLast && onRegenerate && (
            <Button
              variant="ghost"
              size="sm"
              className="h-6 text-xs text-muted-foreground hover:text-foreground hover:bg-muted gap-1.5 px-2"
